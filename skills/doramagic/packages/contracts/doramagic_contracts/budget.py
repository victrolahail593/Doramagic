...
class BudgetSnapshot(BaseModel):
    ...
    def is_exceeded(self) -> bool:
        return self.remaining_usd <= 0 or self.remaining_tokens <= 0 or self.remaining_ms <= 0
