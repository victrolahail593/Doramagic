#!/usr/bin/env python3
"""Doramagic Single-Shot v13.0 — Section-split compiler + GitHub primary + LLM retry.
...
class DebugLogger:
    ...
    def __init__(self, run_dir: Path, run_id: str):
        ...
        self._write("=" * 72)
        self._write("Doramagic Single-Shot v13.0 — Debug Log")
...
def _build_compile_prompt(synthesis, souls, profile, bricks, reference_content,
    ...
    Superseded by _build_shared_compile_packet() + per-section calls in v13.0.
...
def _compile_skill_template(synthesis, souls, profile, bricks=None):
    ...
    lines.append("---")
    lines.append("*Generated by Doramagic v13.0 (template fallback) — 不教用户做事，给他工具。*")
    return "\n".join(lines)
...
def main():
    parser = argparse.ArgumentParser(description="Doramagic Single-Shot v13.0")
